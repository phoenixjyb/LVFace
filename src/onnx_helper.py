...
if __name__ == '__main__':
    ...
    #     # model_files = os.listdir(os.path.join(source_path, model_path))
    #     # model_file = [model_file in model_files if model_file.endwiths('.onnx')][0]
    #     print(os.path.join(source_path, model_path))
    #     handler = ArcFaceORT(os.path.join(source_path, model_path))
    #     err = handler.check('cfat')
    #     print('err:', err)
